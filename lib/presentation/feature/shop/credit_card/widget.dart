...
const Map<CardType, String> CardTypeIconAsset = <CardType, String>{
  CardType.visa: 'assets/icons/ic_visa.png',
  CardType.americanExpress: 'assets/icons/ic_visa.png',
  CardType.mastercard: 'assets/icons/ic_mastercard.png',
  CardType.discover: 'assets/icons/ic_mastercard.png',
};
...
class _CreditCardWidgetState extends State<CreditCardWidget>
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                //     child:
                //         Image.asset('assets/icons/ic_mastercard.png', scale: 1),
                //   ),
                // const Spacer(),
                Align(
  ...
  Widget getCardTypeIcon(String cardNumber) {
    ...
    switch (detectCCType(cardNumber)) {
      case CardType.visa:
        icon = Image.asset('assets/icons/ic_visa.png', height: 48, width: 48);
        isAmex = false;
        break;
      ...
      case CardType.mastercard:
        icon = Image.asset('assets/icons/ic_mastercard.png',
            height: 48, width: 48);
        isAmex = false;
        break;
      ...
      default:
        icon = Container(height: 48, width: 48);
        isAmex = false;
        break;
    }
